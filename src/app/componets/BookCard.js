...
const BookCard = ({ book }) => {
  return (
    <div>
      <li className="cursor-pointer grid grid-cols-2 gap-5 shadow-lg rounded-md pr-2 hover:opacity-75">
        <div className="relative col-span-1 h-[210px] shadow-md">
          ...
          <ImageLoading
            className="absolute w-full h-[210px] object-cover rounded-l-md"
            src={book.image}
          />
        </div>
        <div className="grid-cols-2 flex flex-col gap-2 justify-between">
          ...
          <div>
            ...
            <FaRegShareFromSquare size={18} className="mb-2" color="#FF971D" />
          </div>
        </div>
      </li>
    </div>
